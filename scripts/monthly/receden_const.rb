...
#-------------------------------------------------------------------------------
    ...
    HOrecord=["レコード識別情報"            ,"RECID"            ,A, 2,true ,true],
             ...
             ["食事療養・生活療養回数"      ,"KAISU"            ,N, 2,false,false],
             ["食事療養・生活療養合計金額"  ,"HMONEY"           ,N, 8,false,false],
    ...
    KOrecord=["レコード識別情報"            ,"RECID"            ,A,2, true,true ],
             ...
             ["予備"                        ,"YOBI"             ,N,5,false,false],
             ["食事療養・生活療養回数"      ,"SKJKAISU"         ,N,2,false,false],
             ["食事療養・生活療養合計金額"  ,"SKJMONEY"         ,N,8,false,false]
    ...
    SIrecord=["レコード識別情報"            ,"RECID"            ,A,   2,true ,true ],
             ...
             ["コメントコメントコード"      ,"COMCD1"           ,N,   9,false,false],
             ["コメント文字データ"          ,"COMMENT1"         ,K, 100,false,false],
             ["コメントコメントコード"      ,"COMCD2"           ,N,   9,false,false],
             ["コメント文字データ"          ,"COMMENT2"         ,K, 100,false,false],
             ["コメントコメントコード"      ,"COMCD3"           ,N,   9,false,false],
             ["コメント文字データ"          ,"COMMENT3"         ,K, 100,false,false],
