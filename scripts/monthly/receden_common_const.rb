...
class Receden_common_const
  ...
  ["レセプト種別"             ,"RECESBT"          ,N, 4 ,true ,true],
  ["診療年月"                 ,"SRYYM"            ,N, 5 ,true ,true],
  ["氏名"                     ,"NAME"             ,T,40 ,false,true],
  ["男女区分"                 ,"SEX"              ,N, 1 ,true ,true],
  ["生年月日"                 ,"BIRTHDAY"         ,N, 7 ,true ,true],
  ["給付割合"                 ,"KFRATE"           ,N, 3 ,false,false],
  ["入院年月日"               ,"NYUINYMD"         ,N, 7 ,false,false],
  ["病棟区分"                 ,"BTUKBN"           ,A, 8 ,false,false],
  ["一部負担金・食事療養費・生活療養費標準負担額区分","SKJFTNKBN",N,1,false,false],
  ["レセプト特記事項"         ,"TOKKI"            ,A,10 ,false,false],
  ["病床数"                   ,"BEDSU"            ,N, 4 ,false,false],
  ["カルテ番号等"             ,"PTNUM"            ,A,20 ,false,false],
  ["割引点数単価"             ,"DCTEN"            ,N, 2 ,false,false],
  ["予備"                     ,"YOBI1"            ,N, 1 ,false,false],
  ["予備"                     ,"YOBI2"            ,N, 1 ,false,false],
  ["旧診療科"                 ,"OLDSRYKA"         ,N, 2 ,false,false],
  ["検索番号"                 ,"SELNUM"           ,N,30 ,false,false],
  ...
  HOrecord=["レコード識別情報"            ,"RECID"            ,A, 2,true ,true],
  ["保険者番号"                  ,"HKNJANUM"         ,A, 8,true ,true],
  ["被保険者証（手帳）等の記号"  ,"KIGO"             ,T,40,false,false],
  ["被保険者証（手帳）等の番号"  ,"NUM"              ,T,40,false,true],
  ["診療実日数"                  ,"JNISSU"           ,N, 2,false,true],
  ["合計点数"                    ,"TEN"              ,N, 8,false,true],
  ["予備"                        ,"YOBI"             ,N, 5,false,false],
  ["食事療養・生活療養回数"      ,"SSKAISU"          ,N, 2,false,false],
  ["食事療養・生活療養合計金額"  ,"SSMONEY"          ,N, 8,false,false],
  ["職務上の事由"                ,"RIYU"             ,N, 1,false,false],
  ["証明書番号"                  ,"CERTNUM"          ,N, 3,false,false],
  ["負担金額医療保険"            ,"FTN"              ,N, 9,false,false],
  ["負担金額減免区分"            ,"DCKBN"            ,N, 1,false,false],
  ["負担金額減額割合"            ,"DCRATE"           ,N, 3,false,false],
  ["負担金額減額金額"            ,"DCMONEY"          ,N, 6,false,false]



  ROrecord=["レコード識別情報"            ,"RECID"            ,A, 2,true ,true],
  ["保険者番号"                  ,"HKNJANUM"         ,A, 8,true ,true],
  ["被保険者証（手帳）等の記号"  ,"KIGO"             ,T,40,false,false],
  ["被保険者証（手帳）等の番号"  ,"NUM"              ,T,40,false,true],
  ["診療実日数"                  ,"JNISSU"           ,N, 2,false,true],
  ...
  ["食事療養・生活療養回数"      ,"SSKAISU"         ,N, 2,false,false],
  ["食事療養・生活療養合計金額"  ,"SSMONEY"         ,N, 8,false,false],
  ["老人医療市町村番号"          ,"FTNNUM"           ,A, 8,true ,true],
  ["老人医療受給者番号"          ,"JKYNUM"           ,A, 7,true ,true],
  ["負担金額老人減免区分"        ,"DCKBN"            ,N, 1,false,false],
  ["負担金額老人外来金額"        ,"GAIFTN"           ,N, 6,false,false],
  ["負担金額老人入院金額"        ,"NYUFTN"           ,N, 6,false,false]

  KOrecord=["レコード識別情報"            ,"RECID"            ,A,2, true,true ],
  ["公費負担医療負担者番号"      ,"FTNNUM"           ,A,8, true,true ],
  ["公費負担医療受給者番号"      ,"JKYNUM"           ,N,7,false,false],
  ["公費負担医療任意給付区分"    ,"NINKEIKBN"        ,N,1,false,false],
  ["診療実日数"                  ,"JNISSU"           ,N,2,false,true ],
  ["合計点数"                    ,"TEN"              ,N,8,false,true ],
  ["負担金額公費"                ,"KMONEY"           ,N,8,false,false],
  ["負担金額外来一部負担金公費給付対象","GAIFTN"     ,N,6,false,false],
  ["負担金額入院一部負担金公費給付対象","NYUFTN"     ,N,6,false,false],
  ["予備"                        ,"YOBI"             ,N,5,false,false],
  ["食事療養・生活療養回数"      ,"SSKAISU"          ,N,2,false,false],
  ["食事療養・生活療養合計金額"  ,"SSMONEY"          ,N,8,false,false]

  KHrecord=["レコード識別情報"            ,"RECID"            ,A,  2,true ,true],
  ["国保連固有情報"              ,"TEXT"             ,T,100,false,false]

  SYrecord=["レコード識別情報"            ,"RECID"            ,A,  2,true ,true ],
  ["傷病名コード"                ,"BYOMEICD"         ,N,  7,true ,true ],
  ["診療開始日"                  ,"SRYYMD"           ,N,  7,true ,true ],
  ["転帰区分"                    ,"TENKIKBN"         ,N,  1,true ,true ],
  ["修飾語コード"                ,"MODCD"            ,A, 80,false,false],
  ["傷病名称"                    ,"BYOMEI"           ,K, 40,false,false],
  ["主傷病"                      ,"SYUBYO"           ,N,  2,false,false],
  ["補足コメント"                ,"HSKCOM"           ,K, 40,false,false]

  SIrecord=["レコード識別情報"            ,"RECID"            ,A,   2,true ,true ],
  ["診療識別"                    ,"SRYKBN"           ,N,   2,false,false],
  ["負担区分"                    ,"FTNKBN"           ,A,   1,true ,true ],
  ["診療行為コード"              ,"SRYCD"            ,N,   9,true ,true ],
  ["数量データ"                  ,"SURYO"            ,N,   8,false,false],
  ["点数"                        ,"TEN"              ,N,   7,false,false],
  ["回数"                        ,"KAISU"            ,N,   3,false,false],
  ...
  NIrecord=["レコード識別情報"            ,"RECID"            ,A,2,true ,true ],
  ["１日の情報"                  ,"DAY01"            ,N,3,false,false],
  ["２日の情報"                  ,"DAY02"            ,N,3,false,false],
  ["３日の情報"                  ,"DAY03"            ,N,3,false,false],
  ["４日の情報"                  ,"DAY04"            ,N,3,false,false],
  ...
  GOrecord=["レコード識別情報"            ,"RECID"            ,A, 2,true ,true ],
  ["総件数"                      ,"TOTALKENSU"       ,N, 6,false,false],
  ["総合計点数"                  ,"TOTALTEN"         ,N,10,false,false],
  ["マルチボリューム識別情報"    ,"MVOLID"           ,N, 2,true ,true ]


  SAIrecord=["データ識別コード"           ,"RECID"       ,N,2 ,false ,true ],
  ["行番号"                     ,"LINE"        ,N,5 ,false ,true ],
  ["枝番号"                     ,"BRANCH"      ,N,3 ,false ,true ],
  ["レコード識別情報"           ,"DATA01"      ,A,2 ,true  ,true ],
