...
create index idx_tensu_kananame on tbl_tensu(hospnum, kananame); 
...
create index idx_tensu_name on tbl_tensu(hospnum, name); 
drop index idx_tensu_formalname;
create index idx_tensu_formalname on tbl_tensu(hospnum, formalname); 
