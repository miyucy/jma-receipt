CREATE TABLE "tbl_receprt" (
	...
	Constraint "tbl_receprt_primary_key" Primary Key ("prtid", "receym", "creymd", "crehms", "prefkbn", "prefnum", "hknjanum", "tekstymd", "teisyutusaki", "recesyubetu", "ptnum", "sryym", "rennum", "recenum")
);
