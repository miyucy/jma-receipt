...
ALTER TABLE ONLY tbl_receprtwk
    ADD CONSTRAINT tbl_receprtwk_primary_key PRIMARY KEY (prtid, receym, creymd, crehms, prefkbn, prefnum, hknjanum, tekstymd, teisyutusaki, recesyubetu, ptnum, sryym, rennum, recenum);
