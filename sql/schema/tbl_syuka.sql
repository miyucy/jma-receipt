CREATE TABLE "tbl_syuka" (
	...
	"upymd" character(8),
	"uphms" character(6),
	Constraint "tbl_syuka_primary_key" Primary Key ("hospid", "nyugaikbn", "ptid", "ten_kbn", "sryym", "teisyutusaki", "hknjanum", "hojokbn", "recesyubetu", "sryka")
);

CREATE INDEX idx_syuka_sryym ON tbl_syuka USING btree (hospid, nyugaikbn, sryym);

COMMENT ON TABLE "tbl_adrs" IS '¼ç²Ê¾ðÊó';
