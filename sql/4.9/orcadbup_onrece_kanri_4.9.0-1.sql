...
ALTER TABLE tbl_onrece_kanri DROP CONSTRAINT tbl_onrece_kanri_pkey;
...
ADD CONSTRAINT tbl_onrece_kanri_pkey PRIMARY KEY (HOSPNUM,TEISYUTUSAKI,HOSPCD,SRYYM,UCNT,SCNT,RENNUM);
