...
ALTER TABLE tbl_onrece_body DROP CONSTRAINT tbl_onrece_body_pkey;
...
ADD CONSTRAINT tbl_onrece_body_pkey PRIMARY KEY (HOSPNUM,TEISYUTUSAKI,HOSPCD,SRYYM,UCNT,SCNT,RENNUM,RECEIPT_NO);
