...
CREATE TABLE tbl_sryact_prv (
    ...
    srycd1 character(9),
    srysuryo1 numeric(8,5) DEFAULT 0,
    ...
    srycd2 character(9),
    srysuryo2 numeric(8,5) DEFAULT 0,
    ...
    srycd3 character(9),
    srysuryo3 numeric(8,5) DEFAULT 0,
    ...
    srycd4 character(9),
    srysuryo4 numeric(8,5) DEFAULT 0,
    ...
    srycd5 character(9),
    srysuryo5 numeric(8,5) DEFAULT 0,
